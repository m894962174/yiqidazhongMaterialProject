...
<div id="nav-box">
	...
	<ul id="browser" class="filetree">
		<li><span class="folder">订单模块</span>
			<ul>
            	<li><span class="file"><a onclick="urlTarget('pages/ordersys/order/orderlist');">订单管理</a></span></li>
				<li><span class="file"><a onclick="urlTarget('pages/ordersys/order/orderchecklist');">订单审核</a></span></li>
		  </ul>
	  </li>
	<li><span class="folder">配件模块</span>
			<ul>
            	<li><span class="file"><a onclick="urlTarget('pages/partssys/parts/pnumber/0');">配件管理</a></span></li>
				<li><span class="file"><a onclick="urlTarget('pages/partssys/partsrep/repertorylist/0');">配件出入库管理</a></span></li>
